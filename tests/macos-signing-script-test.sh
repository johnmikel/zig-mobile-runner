...
tar -C "$TMPDIR/extract" -xzf "$DIST/zmr-0.1.0-dev.3-aarch64-macos.15.0.tar.gz"
grep -q 'signed-by-fake-codesign' "$TMPDIR/extract/zmr-0.1.0-dev.3-aarch64-macos.15.0/zmr"
