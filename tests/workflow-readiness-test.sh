...
grep -q 'FORCE_JAVASCRIPT_ACTIONS_TO_NODE24: "true"' "$CI"
grep -q 'actions/setup-go@v5' "$CI"
...
grep -q 'FORCE_JAVASCRIPT_ACTIONS_TO_NODE24: "true"' "$RELEASE"
grep -q 'actions/setup-go@v5' "$RELEASE"
