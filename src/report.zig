...
test "report writes single trace html with terminal event" {
    ...
    }
    {
        ...
        try manifest.writeAll(
            "{\"schemaVersion\":1,\"runnerVersion\":\"0.1.0-dev.1\",\"protocolVersion\":\"2026-04-28\",\"scenarioName\":\"flow\",\"appId\":\"com.example.mobiletest\",\"status\":\"passed\",\"startedAtMs\":1,\"endedAtMs\":2,\"durationMs\":1,\"failedStepIndex\":null,\"error\":null,\"eventsPath\":\"events.jsonl\",\"artifactsDir\":\"artifacts\",\"eventCount\":2,\"snapshotCount\":0,\"reportPath\":null}\n",
        );
    }
...
test "trace explanation summarizes terminal failure diagnostics" {
...

    {
        ...
        defer manifest.close();
        try manifest.writeAll(
            "{\"schemaVersion\":1,\"runnerVersion\":\"0.1.0-dev.1\",\"protocolVersion\":\"2026-04-28\",\"scenarioName\":\"login smoke\",\"appId\":\"com.example.mobiletest\",\"status\":\"failed\",\"startedAtMs\":1,\"endedAtMs\":101,\"durationMs\":100,\"failedStepIndex\":2,\"error\":\"WaitTimeout\",\"eventsPath\":\"events.jsonl\",\"artifactsDir\":\"artifacts\",\"eventCount\":4,\"snapshotCount\":1,\"reportPath\":null}\n",
        );
    }
    {
        var events = try std.fs.cwd().createFile(root ++ "/events.jsonl", .{ .truncate = true });
